...
class PagingAdapterViewModel(result: MainResult) : BaseObservable() {
    val id: Int = result.id @Bindable get

    val title: String = result.title @Bindable get

    val overview: String = result.overview @Bindable get
}