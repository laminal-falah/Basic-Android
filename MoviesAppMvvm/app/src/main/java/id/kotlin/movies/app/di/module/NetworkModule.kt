...
class NetworkModule {
    ...
    @Provides
    @Singleton
    fun providesHttpClient(interceptor: HttpLoggingInterceptor): OkHttpClient = OkHttpClient.Builder().apply {
    ...
    @Provides
    @Singleton
    fun providesHttpAdapter(client: OkHttpClient): Retrofit = Retrofit.Builder().apply {
        client(client)
